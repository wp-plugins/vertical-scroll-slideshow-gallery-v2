...
function vssg2_control()
{
	...
	echo 'click here</a></p>';
	?>
	Check official website for live demo <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-slideshow-gallery-v2/'>click here</a><br>
    <br> 
	<?php
}
...
function vssg2_option() 
{
	...
	?>
	<h2>About Plugin!</h2>
    Plug-in created by <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-slideshow-gallery-v2/'>www.gopiplus.com</a><br> 
	Check official website for live demo and more information <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-slideshow-gallery-v2/'>click here</a><br>
