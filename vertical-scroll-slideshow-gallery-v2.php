...
Description:  Vertical scroll slideshow gallery v2
Author: Gopi.R
Version: 2.0
...
function vssg2_install() 
{
	...
	add_option('vssg2_width', "170px");
	add_option('vssg2_height', "160px");
...
{
	echo '<p>Vertical Scroll Slideshow Gallery V2.<br> To change the setting goto Vertical Scroll Slideshow Gallery V2 link under SETTING tab.';
	...
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-slideshow-gallery-v2/'>Click here</a> To see more info. <br>
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-slideshow-gallery-v2/'>Click here</a> To post suggestion or comments or feedback. <br> 
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-slideshow-gallery-v2/'>Click here</a> To see LIVE demo. <br> 
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-slideshow-gallery-v2/'>Click here</a> To download my other plugins. <br> 
	<?php
}
...
function vssg2_option() 
{
	echo "<div class='wrap'>";
	echo "<h2>"; 
	echo wp_specialchars( "Vertical scroll slideshow gallery v2" ) ;
	echo "</h2>";
	...
	echo '<p>Slide timeout:<br><input  style="width: 200px;" type="text" value="';
    ...
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-slideshow-gallery-v2/'>Click here</a> To post suggestion or comments or feedback. <br> 
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-slideshow-gallery-v2/'>Click here</a> To see LIVE demo. <br> 
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-slideshow-gallery-v2/'>Click here</a> To download my other plugins. 
...
{
  	register_sidebar_widget(__('Vertical Scroll Slideshow Gallery V2'), 'vssg2_widget');   
	if(function_exists('register_sidebar_widget')) 	
	{
		register_sidebar_widget('Vertical Scroll Slideshow Gallery V2', 'vssg2_widget');
	}
	if(function_exists('register_widget_control')) 	
	{
		register_widget_control(array('Vertical Scroll Slideshow Gallery V2', 'widgets'), 'vssg2_control');
	} 
}
...
{
	add_options_page('Vertical Scroll Slideshow Gallery V2', 'Vertical Scroll Slideshow Gallery V2', 7, __FILE__, 'vssg2_option' );
}
