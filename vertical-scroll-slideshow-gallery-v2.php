...
function vssg2_option() 
{
    ...
    <a target="_blank" href='http://www.gopipulse.com/work/2010/07/18/vertical-scroll-slideshow-gallery-v2/'>Please check help page.</a><br>
	<br>Note: Check official website for live demo and more information <a target="_blank" href='http://www.gopipulse.com/work/2010/07/18/vertical-scroll-slideshow-gallery-v2/'>click here</a><br>
	<?php
	echo "</div>";
